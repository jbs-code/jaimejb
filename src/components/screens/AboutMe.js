    ...
    <div className='about-me'>
      ...
      <article className='card'>
        <div className='card-container__img'>
          <img src='/assets/jaime.jpg' alt='Foto de Jaime' />
        </div>
      ...
      <article className='card'>
        ...
        <div className='card-container__img'>
          <img src='/assets/perros.png' alt='Foto de perros' />
        </div>
      </article>
      ...
      <article className='card'>
        <div className='card-container__img'>
          <img src='/assets/tyre.jpg' alt='Foto de F1' />
        </div>
      ...
      <article className='card'>
        ...
        <div className='card-container__img'>
          <video src="/assets/videos/reloj.webm" autoPlay loop>
      ...
      <article className='card'>
        <div className='card-container__img'>
          <video src="/assets/videos/coding.webm" autoPlay loop>
            Tu navegador no admite el elemento <code>video</code>.
          </video>
        </div>
